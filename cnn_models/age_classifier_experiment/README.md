...
An experiment adapting a CNN architecture originally designed for age classification, from Aydogdu, M.F. and Demirci, M.F., *Age Classification Using an Optimized CNN Architecture*, and applying it to deepfake detection instead.
...
- `final_model_results.py`: generates and saves results across all 12 model variants, including the best- and worst-performing confusion matrices and all 12 validation curves.

...
Research code for an independent study applying convolutional neural networks to deepfake image detection — from exploratory data analysis and classical ML baselines through transfer learning with established CNN architectures and a custom-built model.
...
2. **Classical ML baselines** — KNN, Random Forest, Logistic Regression, and SVM models trained on brightness values and raw pixel data, to establish a performance floor before moving to deep learning.
...
4. **Custom CNN** — an original architecture iterated across several versions (data augmentation, batch normalization, learning-rate scheduling).
...
- Full architecture-by-architecture comparisons (VGG16, VGG19, DenseNet121, ResNet50, and the custom model) and methodology are detailed in the [published paper](https://nhsjs.com/2025/applications-of-existing-convolutional-neural-networks-to-deepfake-detection/).
...
All models were trained and evaluated on the [CIFAKE: Real and AI-Generated Synthetic Images](https://www.kaggle.com/datasets/birdy654/cifake-real-and-ai-generated-synthetic-images) dataset from Kaggle (~20,000 real images and ~60,000 AI-generated images).
...
Download the [CIFAKE dataset](https://www.kaggle.com/datasets/birdy654/cifake-real-and-ai-generated-synthetic-images) from Kaggle before running any preprocessing or training scripts — the scripts assume it has been downloaded locally.
...
- Age classification architecture adapted from: Aydogdu, M.F. & Demirci, M.F., *Age Classification Using an Optimized CNN Architecture*
